  ...
  <el-form ref="form-create-announce" label-position="top">
    ...
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item v-if="formData.modelId" label="Kw">
          ...
          >
            <el-option v-for="kw in kws" :key="kw" :label="kw" :value="kw">
            </el-option>
          </el-select>
        </el-form-item>
      </el-col>
    ...
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item
          v-if="
            (formData.serialId !== 'other' && formData.serialId !== null) ||
            formData.other
          "
          label="Body"
        >
    ...
    <el-button :disabled="!formData.body" @click="goToStep2"
      >Next Step</el-button
    >
